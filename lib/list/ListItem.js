...
var ListItem = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      var wrapCls = (0, _classnames5["default"])("".concat(prefixCls, "-item"), className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-item-disabled"), disabled), _defineProperty(_classnames, "".concat(prefixCls, "-item-error"), error), _defineProperty(_classnames, "".concat(prefixCls, "-item-top"), align === "top"), _defineProperty(_classnames, "".concat(prefixCls, "-item-middle"), align === "middle"), _defineProperty(_classnames, "".concat(prefixCls, "-item-bottom"), align === "bottom"), _classnames));
      var rippleCls = (0, _classnames5["default"])("".concat(prefixCls, "-ripple"), _defineProperty({}, "".concat(prefixCls, "-ripple-animate"), RippleClicked));
      var lineCls = (0, _classnames5["default"])("".concat(prefixCls, "-line"), (_classnames3 = {}, _defineProperty(_classnames3, "".concat(prefixCls, "-line-multiple"), multipleLine), _defineProperty(_classnames3, "".concat(prefixCls, "-line-wrap"), wrap), _classnames3));
      var arrowCls = (0, _classnames5["default"])("".concat(prefixCls, "-arrow"), (_classnames4 = {}, _defineProperty(_classnames4, "".concat(prefixCls, "-arrow-horizontal"), arrow === "horizontal"), _defineProperty(_classnames4, "".concat(prefixCls, "-arrow-vertical"), arrow === "down" || arrow === "up"), _defineProperty(_classnames4, "".concat(prefixCls, "-arrow-vertical-up"), arrow === "up"), _classnames4));
      ...
      return /*#__PURE__*/React.createElement(_touchEffect["default"], _extends({}, touchProps, {
