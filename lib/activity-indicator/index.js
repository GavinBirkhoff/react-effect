...
var ActivityIndicator = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ActivityIndicator, [{
    ...
    value: function render() {
      ...
      var wrapClass = (0, _classnames3["default"])(prefixCls, className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-lg"), size === "large"), _defineProperty(_classnames, "".concat(prefixCls, "-sm"), size === "small"), _defineProperty(_classnames, "".concat(prefixCls, "-toast"), !!toast), _classnames));
      var spinnerClass = (0, _classnames3["default"])("".concat(prefixCls, "-spinner"), _defineProperty({}, "".concat(prefixCls, "-spinner-lg"), !!toast || size === "large"));
