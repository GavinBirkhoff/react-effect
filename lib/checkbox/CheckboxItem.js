...
var ListItem = _list["default"].Item; // eslint-disable-next-line @typescript-eslint/no-empty-function
...
var CheckboxItem = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(CheckboxItem, [{
    ...
    value: function render() {
      ...
      var wrapCls = (0, _classnames2["default"])("".concat(prefixCls, "-item"), className, _defineProperty({}, "".concat(prefixCls, "-item-disabled"), disabled === true)); // Note: if not omit `onChange`, it will trigger twice on check listitem
      ...
      return /*#__PURE__*/React.createElement(ListItem, _extends({}, restProps, {
        prefixCls: listPrefixCls,
        className: wrapCls,
        thumb: /*#__PURE__*/React.createElement(_Checkbox["default"], _extends({}, checkboxProps, extraProps))
      }), children);
    }
  }]);
