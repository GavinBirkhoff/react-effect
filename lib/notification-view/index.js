...
var NotificationView = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(NotificationView, [{
    ...
    value: function render() {
      ...
      var warpCls = (0, _classnames2["default"])(prefixCls, className, _defineProperty({}, "".concat(prefixCls, "-modal"), notification.some(function (e) {
        return e.modal;
      })));
    ...
    value: function buttons(n) {
      ...
      }, n.acceptButton !== undefined && /*#__PURE__*/React.createElement(_index["default"], {
        inline: true,
      ...
      }, n.acceptButton), n.declineButton !== undefined && /*#__PURE__*/React.createElement(_index["default"], {
        inline: true,
