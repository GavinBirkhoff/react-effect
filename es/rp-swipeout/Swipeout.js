...
import Gesture from "gesture-effect";
...
var Swipeout = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Swipeout, [{
    ...
    value: function renderButtons(buttons, _ref) {
      ...
      return buttons && buttons.length ? /*#__PURE__*/React.createElement("div", {
    ...
    value: function render() {
      ...
      return (left.length || right.length) && !disabled ? /*#__PURE__*/React.createElement("div", _extends({
        className: cls
      ...
      }), this.renderButtons(left, "left"), this.renderButtons(right, "right"), /*#__PURE__*/React.createElement(Gesture, _extends({
      ...
      }, refProps), /*#__PURE__*/React.createElement("div", {
        className: "".concat(prefixCls, "-content")
      }, children))) : /*#__PURE__*/React.createElement("div", _extends({}, refProps, divProps), children);
    }
  }]);
