...
var ListItem = List.Item; // eslint-disable-next-line @typescript-eslint/no-empty-function
...
var CheckboxItem = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(CheckboxItem, [{
    ...
    value: function render() {
      ...
      var wrapCls = classnames("".concat(prefixCls, "-item"), className, _defineProperty({}, "".concat(prefixCls, "-item-disabled"), disabled === true)); // Note: if not omit `onChange`, it will trigger twice on check listitem
      ...
      return /*#__PURE__*/React.createElement(ListItem, _extends({}, restProps, {
        ...
        className: wrapCls,
        thumb: /*#__PURE__*/React.createElement(Checkbox, _extends({}, checkboxProps, extraProps))
      }), children);
    }
  }]);
