...
var Progress = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Progress, [{
    ...
    value: function render() {
      ...
      var wrapCls = classnames("".concat(prefixCls, "-outer"), className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-fixed-outer"), position === "fixed"), _defineProperty(_classnames, "".concat(prefixCls, "-hide-outer"), !unfilled), _classnames));
